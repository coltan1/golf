...
const BEACH = [
  {
    ...
    shore: { side: 1, y: SEA, off: [[0, 52], [180, 46], [330, 38], [402, 34]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: 1, y: SEA,
             off: [[0, 50], [40, 34], [70, -30], [130, -28], [156, 30], [200, 54]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: -1, y: SEA, off: [[0, -46], [220, -38], [400, -40], [546, -34]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: 1, y: SEA, off: [[0, 54], [200, 44], [320, 34], [370, 30]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: -1, y: SEA, off: [[0, -66], [260, -52], [440, -42], [562, -36]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: 1, y: SEA,
             off: [[0, 46], [46, 22], [86, -24], [124, 20], [170, 40]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: 1, y: SEA, off: [[0, 50], [190, 36], [300, 32], [388, 38]] },
    bunkers: [
  ...
  },
  {
    ...
    shore: { side: -1, y: SEA, off: [[0, -58], [240, -42], [380, -34], [470, -30]] },
    bunkers: [
